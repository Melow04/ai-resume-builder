    ...
    <nav className="fixed top-0 left-0 right-0 z-50 glass border-b border-white/5 backdrop-blur-xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center h-16">
          {/* Logo */}
          <Link href="/" className="flex items-center gap-2 group" aria-label="Resumint Home">
            <div className="w-10 h-10 rounded-lg flex items-center justify-center">
              <Image src="/assets/resumint-mark.svg" alt="Resumint Logo" width={25} height={25} className="w-10 h-10" />
            </div>
